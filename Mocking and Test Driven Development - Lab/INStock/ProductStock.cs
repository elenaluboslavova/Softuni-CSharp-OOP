...
namespace INStock
{
    public class ProductStock : IProductStock
    {
        ...
        public IEnumerable<IProduct> FindAllInPriceRange(decimal lowerEnd, decimal higherEnd)
        {
        ...
        public IEnumerable<IProduct> GetEnumerator<IProduct>()
        {
            return (IEnumerable<IProduct>)this.products;
        }
